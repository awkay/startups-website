(ns startupsite.ui.root
  (:require
    ...
    [startupsite.ui.components :as components :refer [ui-placeholder ScrollTarget ui-scroll-target]] ; preload translations by requiring their namespace. See Makefile for extraction/generation
    translations.es
